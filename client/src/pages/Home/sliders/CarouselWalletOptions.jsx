...
import WalletOptions from '../cardLinks/WalletOptions';

const CarouselWalletOptions = ({ list }) => {
  ...
  return (
    <div className="carousel bg-indigo-dark-gradient rounded-xl">
...
export default CarouselWalletOptions;
