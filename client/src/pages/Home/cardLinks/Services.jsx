...
const Services = ({ data }) => {
  ...
  const notificationInfoBox = (
    <div className="flex flex-col w-[200px] h-[230px] justify-center rounded-xl items-center shadow-lg overflow-hidden bg-indigo-dark-gradient">
    <div className={`w-[80px] p-2 rounded-xl ${styles.flexCenter}`}>
      ...
      <button
        className={`mt-6 mb-6 py-2 px-3 ${styles.paragraph2Hover} bg-pIndigoButton hover:opacity-90 rounded-[10px] outline-none cursor-pointer ${styles}`}
        //   onClick={setIsTokenModalVisible}
