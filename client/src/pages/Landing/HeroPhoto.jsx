...
const HeroPhoto = ({ heroPhotoBackgroundImage }) => {
  ...
  return (
    ...
    >
      <div 
      // className="w-full self-stretch bg-darkslategrey-200 overflow-hidden flex flex-row items-center justify-center p-2.5"
      className="w-full self-stretch bg-black/50 overflow-hidden flex flex-row items-center justify-center p-2.5"
      >
