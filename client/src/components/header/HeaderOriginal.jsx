    ...
    <>
      <div className="flex flex-col md:flex-row gap-[32px] md:justify-between md:gap-0 mt-[8px] w-screen text-[16px]">
        <div className="flex flex-col md:flex-row gap-[32px] ml-[20px]">
          <div
            className="cursor-pointer  text-mediumseagreen-200  text-center inline-block"
            onClick={() => {
              navigate('/');
              setActiveTab(1);
            }}
          ...
          <div className={`flex flex-col md:flex-row gap-[32px] ml-[20px]`}>
            <div
              className={`${
                activeTab === 2 ? `text-mediumseagreen-200` : `text-gray-900`
            ...
            {user?.role && (
              <div
                className={`${
                  activeTab === 3 ? `text-mediumseagreen-200` : `text-gray-900`
                } cursor-pointer text-center inline-block`}
                onClick={() => {
        ...
        <div className="flex flex-col md:flex-row gap-[32px] mr-[20px]">
          ...
          {user?.role ? (
            <>
              <div
                className={`${
                  activeTab === 4 ? `text-mediumseagreen-200` : `text-gray-900`
                } cursor-pointer text-center inline-block`}
                onClick={() => {
                  navigate('/account');
                  setActiveTab(4);
