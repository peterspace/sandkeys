...
export default function AdminBookingsPage() {
  ...
  function filterUserData1() {
    if (bookings) {
      const userData = bookings?.filter((item) => {
        return (
          item.owner.toLowerCase().includes(user?._id?.toLowerCase()) &&
